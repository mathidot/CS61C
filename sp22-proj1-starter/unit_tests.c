...
{
  // TODO: Implement this if you'd like!
  if(!assert_true("w",is_snake('w'))){
    return false;
  }
  if(!assert_true("a",is_snake('a'))){
    return false;
  }
  if(!assert_true("s",is_snake('s'))){
    return false;
  }
  if(!assert_true("d",is_snake('d'))){
    return false;
  }
  if(!assert_true("^",is_snake('^'))){
    return false;
  }
  if(!assert_true("v",is_snake('v'))){
    return false;
  }
  if(!assert_true("<",is_snake('<'))){
    return false;
...
{
  // TODO: Implement this if you'd like!
  if(!assert_equals_int(">",1,incr_x('>'))){
    return false;
  }
  if(!assert_equals_int("d",1,incr_x('d'))){
    return false;
  }
  if(!assert_equals_int("<",-1,incr_x('<'))){
    return false;
  }
  if(!assert_equals_int("a",-1,incr_x('a'))){
    return false;
  }
  return true;
}
...
{
  // TODO: Implement this if you'd like!
  if(!assert_equals_int("v",1,incr_y('v'))){
    return false;
  }
  if(!assert_equals_int("s",1,incr_y('s'))){
    return false;
  }
  if(!assert_equals_int("^",-1,incr_y('^'))){
    return false;
  }
  if(!assert_equals_int("w",-1,incr_y('w'))){
    return false;
  }
  return true;
}
